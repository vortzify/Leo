import {CollectionRendererContext as $7135fc7d473fd974$export$4feb769f8ddf26c5, renderAfterDropIndicators as $7135fc7d473fd974$export$2dbbd341daed716d} from "./Collection.module.js";
...
function $ce3a951440fc273f$var$renderWrapper(parent, reusableView, renderDropIndicator) {
    ...
    if ((node === null || node === void 0 ? void 0 : node.type) === 'item' && renderDropIndicator && layout.getDropTargetLayoutInfo) rendered = /*#__PURE__*/ (0, $dVUg9$react).createElement((0, $dVUg9$react).Fragment, {
        key: reusableView.key
